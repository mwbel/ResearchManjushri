---
title: 通用 Knowledge Network
type: domain
status: active
created: 2026-06-17
updated: 2026-06-17
summary: 通用 单学科知识网络入口，串联网页文章、本地资料、source summary、concept、analysis 与待办问题。
tags: [general, domain-network]
sources: []
---

# 通用 Knowledge Network
...
- Connected wiki pages: 0
- Inbox sources waiting for ingest: 0
- Generated on: 2026-06-17

## How To Add Knowledge

- Web article: `python3 scripts/new_source.py --domain general --kind article --title "标题" --url "https://..."`
- Local file: `python3 scripts/new_source.py --domain general --kind paper --title "标题" --local-path "/absolute/path/to/file.pdf"`
...
| --- | --- | --- | --- |
| concept | 暂无页面 | 等待首批资料 ingest 后生成 | `wiki/...` |
