...
flowchart LR
    ...
    D --> W1["analysis: 2026-04-09 Team Handoff Chat Hist…"]
    D --> W2["analysis: 时轮历交食算法逐步拆解"]
    D --> W3["analysis: 时宪历交食算法逐步拆解"]
    D --> W4["concept: Tibetan Astronomy Calendar"]
    D --> W5["concept: 西藏时宪历交食推步"]
    D --> W6["concept: 交食推步参数总表"]
    D --> W7["concept: 西藏交食推步术语与单位表"]
...
| concept | [Tibetan Astronomy Calendar](../concepts/tibetan-astronomy-calendar.md) | 西藏天文历算总览页，用来组织历算规则、周期算法、术语体系、交食推步与相关历史背景。 | `wiki/concepts/tibetan-astronomy-calendar.md` |
| concept | [西藏时宪历交食推步](../concepts/tibetan-eclipse-calculation.md) | 对西藏时宪历中日月食推步流程的概念化整理，涵盖常数、查表、损益修正、判食限与食时求法。 | `wiki/concepts/tibetan-eclipse-calculation.md` |
...
| concept | [西藏交食推步术语与单位表](../concepts/tibetan-eclipse-terms-and-units.md) | 汇总当前资料中交食推步涉及的时间单位、角度单位、关键术语与方向表达，作为后续算例拆解的公共参考页。 | `wiki/concepts/tibetan-eclipse-terms-and-units.md` |
