...
- Web article: `python3 scripts/new_source.py --domain modern-astronomy --kind article --title "标题" --url "https://..."`
- Local file: `python3 scripts/new_source.py --domain modern-astronomy --kind paper --title "标题" --local-path "/absolute/path/to/file.pdf"`
