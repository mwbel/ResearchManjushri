...
- 一组交食推步基本数据，包括历元、岁首、首朔、周岁、朔策、朔应、太阳平行、太阳自行、太阴自行、罗喉距月等常数
...
- 还给出了太阳平行、太阳自行、太阴自行、太阴与太阳平行差等推步用常数。
- 这些参数已经整理成 [交食推步参数总表](../concepts/tibetan-eclipse-parameters.md)。

### 2. 符号与单位层

- 资料明确解释了日、时、刻、分、秒、微、纤等时间单位和度、分、秒等角度单位。
- 符号表已经整理成 [西藏交食推步术语与单位表](../concepts/tibetan-eclipse-terms-and-units.md)。

### 3. 推算流程层

- 月食算例大致包括：积年、积月、积日、求五项根数、求太阳/月亮损益数、求平距时与实距时、求实望、求定望、判食限、求食分、求初亏食既食甚生光复圆时刻。
...
- 它已经衍生出交食推步总览、术语与单位表、参数总表和两页逐步算法拆解。
